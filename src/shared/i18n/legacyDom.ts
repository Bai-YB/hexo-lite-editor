...
const exact: Record<string, string> = {
  ...
  "常规": "General", "编辑体验": "Editing", "图片与插件": "Images & plugins", "图片与图床": "Images & plugins", "Hexo 与发布": "Hexo & publishing", "内容同步": "Content sync", "维护": "Maintenance",
  ...
  "检查更新": "Check for updates", "检查中": "Checking", "下载更新": "Download update", "重启并安装": "Restart and install", "当前已经是最新版本。": "You are up to date.",

...
- Windows 安装包没有商业代码签名证书，首次运行可能提示"未知发布者"；校验值见 [SHA256SUMS.txt](https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.2/SHA256SUMS.txt)，更新包在安装前经过签名验证。
</details>

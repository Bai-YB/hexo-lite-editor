...
- 发布标签 `v1.0.6.5`（annotated），源码提交 `f45834ec25ba49009ca534b58883374dc86af2d6`（`v1.0.6.5` 标签提交）；Release 于 2026-09-19T12:53:43Z 公开：https://github.com/Bai-YB/hexo-lite-editor/releases/tag/v1.0.6.5。

<div align="center">
  ...
  <p>
    <a href="https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.1/Hexo-Lite-Editor_1.0.6.5.1_windows-x64-setup.exe"><strong>Download setup</strong></a>
...
`v1.0.6.5.1` supports Windows 10/11 x64 and universal macOS. The displayed version is **1.0.6.5.1**; the internal Tauri-compatible version is `1.0.6+5.1`. Existing 1.0.6.x builds can recognize this update.

This hotfix resolves a Windows packaged-build startup freeze and requires both installer and portable smoke tests to keep a responsive window for three continuous seconds. Other functionality carries forward from 1.0.6.5. See the [1.0.6.5.1 validation record](docs/validation-1.0.6.5.1.md) and [module documentation](docs/modules/README.md).

| Package | Use |
| --- | --- |
| [Setup EXE](https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.1/Hexo-Lite-Editor_1.0.6.5.1_windows-x64-setup.exe) | Recommended; install with the setup wizard |
| [Portable ZIP](https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.1/Hexo-Lite-Editor_1.0.6.5.1_windows-x64-portable.zip) | Extract and run |
| [MSI](https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.1/Hexo-Lite-Editor_1.0.6.5.1_windows-x64.msi) | Managed or bulk deployment |
...
The Windows packages do not have a commercial code-signing certificate, so SmartScreen may show “Unknown publisher.” Checksums are in [SHA256SUMS.txt](https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.1/SHA256SUMS.txt) and [SHA256SUMS-macos.txt](https://github.com/Bai-YB/hexo-lite-editor/releases/download/v1.0.6.5.1/SHA256SUMS-macos.txt). Updates are checked quietly; users choose when to download and install. Background downloading is optional, and update packages are verified with Tauri signatures.
